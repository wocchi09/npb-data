...
トップページまたはANALYST LABの「期間比較・変化検出」から [比較ワークベンチ](workbench.html) を開けます。任意の2期間、相手左右、得点圏、球種、カウント、コースで比較し、配球順序から該当打席のリプレイへ移動できます。変化候補の自動検出、条件保存、母数・取得率・参考区間、PNGカードとMarkdown出力に対応しています。[仕様・更新方法](docs/WORKBENCH.md)
...
「成績 → 学年別成績」では、4月2日から翌年4月1日を同一学年として、同学年選手の
シーズン成績とNPB一軍通算成績を野手・投手別に比較できます。
